...
import de.tuclausthal.isse.softwaretechnik.ws2019.carconfigurator.view.impl.CarConfiguratorUI;

public class CarConfiguratorController implements ActionListener, ItemListener {

	private CarConfiguratorUI view;
	private static Feature feature;

	public CarConfiguratorController(CarConfiguratorUI view) {
		this.view = view;
