...
import de.tuclausthal.isse.softwaretechnik.ws2019.carconfigurator.controler.impl.CarConfiguratorController;
import de.tuclausthal.isse.softwaretechnik.ws2019.carconfigurator.model.impl.Feature;

public class CarConfiguratorUI {
	static Feature feature = new Feature("1", 1);
	static CarConfiguratorUI view = new CarConfiguratorUI();
	...
	static JButton  bestellButton;
	static JButton backButton;

	public CarConfiguratorUI() {
	...
	public static void Frame() {
		...
		JLabel labelPaket = new JLabel("wählen Sie ein Ausstattungspaket");
		 ...
		 bestellButton = new JButton("bestellen");
	...
	public static JButton getBestellButton() {
